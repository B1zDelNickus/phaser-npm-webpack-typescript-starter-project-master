...
export class SnowFrontParticles implements IParticle {
    ...
    init( asset?: string, frames?: any|any[]): void {
        ...
        this.emitter.makeParticles(ImageUtils.getSpritesheetClass('SpritesheetsSnowLarge64646').getName(), [0, 1, 2, 3, 4, 5]);
    ...
    start(): void {
        this.emitter.start(false, 6000, 1000);
    }
